...
class Goal(WorldObj):
    ...
    def render(self, img):
        fill_coords(img, point_in_rect(0.2, .8, 0.2, .8), COLORS[self.color])
...
class Grid:
    ...
    def render_tile(
        ...
        if agent_dir is not None:
            ...
            '''
            tri_fn = point_in_rect(0.1, 0.9, 0.1, 0.9)
            tri_fn = point_in_circle(0.5, 0.5, 0.25)
            '''
